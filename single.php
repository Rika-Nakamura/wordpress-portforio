...
<head>
    ...
    <meta name="description" content="webコーダーをめざす中村理香のポートフォリオサイトです">
    <title>Rika Nakamura portforio | Works-item1 </title>
...
<body>
    ...
    <header class="header">
        <div class="header__inner wrapper">
            <p class="header__logo">
                <a href="index.html">
                    <img src="img/Home/logo.png" alt="ヘッダーロゴ">
                </a>
            </p>
            <div class="nav-wrapper">
                <nav class="header__nav">
                    <ul class="header__nav_list ">
                        <li class="header__nav_item"><a href="works.html">works</a></li>
                        <li class="header__nav_item"><a href="about.html">about</a></li>
                        <li class="header__nav_item"><a href="contact.html">contact</a></li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <main>
        ...
        <section class="worksSec adjustment-top wrapper">
            ...
            <div class="worksSec__slideshow">
                <div class="slide">
                    <img id="slide_img" src="img/works/works-item2-1.png">
                </div>
                <div class="toolbar">
            ...
            <div class="btn worksSec__btn"><a href="works.html">戻る</a></div>
        </section>
        <!-- //workSec -->
    ...
    <!-- footer -->
    <footer>
        <small>&copy;2022 Rika Nakamura</small>
    </footer>
    <!-- //footer -->
    ...
    <script src="js/works-item.js"></script>
